function getUsers() {
    ...
    xmlUsers.open("GET", "http://192.168.64.2/io_exb/controller/get_users.php");
    xmlUsers.send();
  }
  ...
  function getUser() {
    ...
    xmlUsers.open("GET", "http://192.168.64.2/io_exb/controller/get_user.php?id="+id);
    xmlUsers.send();
  }

  function addUser() {
    var url =
      'http://192.168.64.2/io_exb/controller/add_user.php';
  ...
  function updateUser() {
    ...
    var url =
      'http://192.168.64.2/io_exb/controller/update_user.php?id='+id;
    var xhttp = new XMLHttpRequest();
    xhttp.open('POST', url, true);
  ...
  function deleteUser() {
    ...
    xmlUsers.open("GET", "http://192.168.64.2/io_exb/controller/delete_user.php?id="+id);
    xmlUsers.send();
  }
